 ...
 *
 */
class BannedIpFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'comment' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => '', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'mask' => ['type' => 'unique', 'columns' => ['address'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'start_time' => '2017-06-14 05:02:49',
            'end_time' => '2017-06-14 05:02:49',
